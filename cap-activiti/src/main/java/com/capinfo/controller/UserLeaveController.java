...
import com.capinfo.entity.BaseTask;
import com.capinfo.entity.LeaveOpinion;
...
//            UserLeave userLeave = (UserLeave) variables.get("userLeave");
    ...
    @ResponseBody
    public String showTaskList(Model model, com.capinfo.entity.Task task, String page, String limit) {
        CurrentUser user = CommonUtil.getUser();
        ...
        List<com.capinfo.entity.Task> tasks = new ArrayList<>();
        Map<String, Object> map = new HashMap<>();
        com.capinfo.entity.Task taskEntity = null;
        ...
        for (Task task1 : taskList) {
            ...
            taskEntity = new com.capinfo.entity.Task(task1);
